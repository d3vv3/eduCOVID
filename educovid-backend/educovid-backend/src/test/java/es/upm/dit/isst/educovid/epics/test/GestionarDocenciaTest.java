...
import java.net.URL;
public class GestionarDocenciaTest {
  ...
  public void gestionarDocencia() {
    ...
    driver.findElement(By.id("formGroupName")).click();
    driver.findElement(By.id("formGroupName")).sendKeys("GRUPO 12");
    {
      WebElement dropdown = driver.findElement(By.id("groupStudents"));
      dropdown.findElement(By.xpath("//option[. = 'Bob Esponja']")).click();
    }
    driver.findElement(By.cssSelector(".btn > div")).click();
    driver.findElement(By.cssSelector(".person-card:nth-child(2)")).click();
    driver.findElement(By.cssSelector(".nord-button:nth-child(1)")).click();
    driver.findElement(By.id("formGroupName")).click();
    driver.findElement(By.id("formGroupName")).sendKeys("GRUPO 1");
    driver.findElement(By.cssSelector(".btn > div")).click();
  }
}
